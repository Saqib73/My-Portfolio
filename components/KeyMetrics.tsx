...
const metrics = [
  {
    ...
    value: "3-4 Months",
    label: "Experience",
    description: "Dedicated to Learning and Mastering the Art of FullStack Development",
  },
  {
    id: 2,
    value: "5+",
    label: "Projects Completed",
    description: "From Small Scale to Large Scale Projects",
  },
  {
    id: 3,
    value: "10+",
...
export const KeyMetrics = () => {
  ...
  return (
    <motion.section
      ...
      className="con px-4 py-32 text-white glass "
    >
